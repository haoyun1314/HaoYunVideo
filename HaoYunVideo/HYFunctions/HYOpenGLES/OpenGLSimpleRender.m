...
#pragma mark - 色调
NSString *const kHueFragmentShaderString = SHADER_STRING
(
 precision highp float;
 varying highp vec2 textureCoordinate;
...
@property (nonatomic, assign) GLint hueUniform;
...
- (instancetype)init {
    if (self = [super init]) {
        ...
        self.hueUniform = [self.program uniformIndex:@"hueAdjust"];
...
//    glUniform1f(self.hueUniform, self.percent);
